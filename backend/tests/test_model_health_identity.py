...
def test_deepseek_v4_is_strong_reasoning_model():
    """DeepSeek V4 (v4-flash / v4-pro) ???? reasoning????????????"""
    assert model_health._is_strong_reasoning_model(_model("DeepSeek-V4-Flash", "deepseek-v4-flash")) is True
    assert model_health._is_strong_reasoning_model(_model("DeepSeek-V4-Pro", "deepseek-v4-pro")) is True
    assert model_health._is_strong_reasoning_model(_model("DeepSeek-V4-Flash", "deepseek-v4-flash")) is True

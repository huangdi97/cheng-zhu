...
Run: `cd backend && python -m pytest tests/test_prompt_polish.py -v`
...
Run: `cd backend && python -m pytest tests/test_assist_asr_interrupt.py tests/test_kb_prompts.py -v`
...
Run: `cd backend && python -m pytest tests/ -x --tb=short --ignore=tests/stress_test_interview.py --ignore=tests/test_preflight_real_audio.py`
Expected: all PASS.
...
Run: `cd backend && python -m pytest tests/test_bench_prompt.py -v`
...
Run:
```bash
cd backend && python -m scripts.bench_prompt \

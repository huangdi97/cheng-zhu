        ...
        >
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1 flex-wrap">
              ...
              {rec.is_active && (
                <span className="text-[10px] px-1 rounded bg-accent-green/20 text-accent-green shrink-0">当前</span>
              )}
            ...
            {!rec.parsed_ok && rec.parse_error && (
              <p className="text-[10px] text-accent-amber/90 mt-1 line-clamp-2">{rec.parse_error}</p>
            )}
          </div>

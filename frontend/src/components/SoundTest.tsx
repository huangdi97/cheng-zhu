  ...
  return (
    <div className="preflight-panel animate-fade-up">
      <div className="flex items-center gap-3 mb-4">
        <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-accent-blue/20 to-accent-blue/15 text-accent-blue ring-1 ring-accent-blue/20">

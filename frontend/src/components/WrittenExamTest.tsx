  ...
  return (
    <div className="preflight-panel animate-fade-up">
      <div className="flex items-center gap-3 mb-4">
        <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-accent-green/20 to-accent-blue/15 text-accent-green ring-1 ring-accent-green/20">
      ...
      <div className="flex items-start gap-2 mb-4">
        ...
        {!hasAnyResult ? (
          ...
          <button
            ...
            onClick={handleRun}
            disabled={running}
            className="flex items-center gap-1.5 px-3 py-2 btn-subtle text-xs font-medium rounded-xl disabled:opacity-50 flex-shrink-0"
          >

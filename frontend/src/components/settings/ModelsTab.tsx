              ...
              return (
                ...
                >
                  <div className="flex items-stretch gap-2">
                    ...
                    <div className="flex items-center justify-center w-8 flex-shrink-0 my-2 rounded-lg bg-accent-blue/20 text-accent-blue/80 text-sm font-bold tabular-nums">
                      {idx + 1}
                    </div>
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        {m.supports_vision && (
                          <span className="inline-flex items-center gap-0.5 text-[10px] text-accent-blue flex-shrink-0 px-1.5 py-0.5 rounded-md bg-accent-blue/10">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-1">
                        ...
                        <span className={`inline-flex items-center gap-0.5 text-[10px] px-1.5 py-0.5 rounded-full font-medium ${
                          keyHasValue ? 'bg-accent-green/15 text-accent-green' : 'bg-accent-red/15 text-accent-red'
                        }`}>
                      ...
                      <div className="px-4 pb-4 space-y-3 border-t border-bg-hover/50 pt-3">
                        ...
                        {probe && (
                          ...
                          >
                            ...
                            <span className={probe.supports_vision ? 'text-accent-blue/80' : 'text-text-muted'}>
                              识图 {probe.supports_vision ? '支持' : '未检测到'}
                            </span>
                            <span className={probe.supports_think ? 'text-accent-green/80' : 'text-text-muted'}>
                            ...
                            <span className={`max-w-full truncate font-mono text-[10px] ${needsThinkDisableProbe ? 'text-accent-amber/80' : 'text-text-muted'}`}>
                              {thinkDisabledLabel}
                            </span>
                            {needsThinkDisableProbe && (
                              <button
                                ...
                                className="rounded-md border border-accent-amber/30 bg-accent-amber/25 px-1.5 py-0.5 text-[10px] font-medium text-accent-amber/80 hover:bg-accent-amber/25 disabled:opacity-50"

...
export function StatusBadge({
  ...
  const styles = {
    ok: 'bg-accent-green/15 text-accent-green border-accent-green/20',
    error: 'bg-accent-red/15 text-accent-red border-accent-red/20',
    checking: 'bg-accent-amber/15 text-accent-amber border-accent-amber/20',
...
export function SaveStateBadge({
  ...
  const styles: Record<SaveState, string> = {
    idle: mode === 'auto'
      ...
      : 'bg-accent-blue/10 text-accent-blue border-accent-blue/35',
